...
func TestLog(t *testing.T) {
	...
	logger2.Info("logger", zap.String("name", "修华师6"))
	logger2.Error("logger", zap.String("name", "修华师7"))
	logger2.Debug("logger", zap.String("name", "修华师8"))
}
...
func InitLog(logPath, errPath string, logLevel zapcore.Level) {
	...
	logger2 = zap.New(core, zap.AddCaller(), zap.AddStacktrace(zap.WarnLevel))
